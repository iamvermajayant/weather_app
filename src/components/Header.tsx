...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur py-2 p-4 supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
            ...
            <div>
                ...
                flex items-center transition-transform duration-500 ${isDark ? "rotate-180" : "rotate-0"}`}>
